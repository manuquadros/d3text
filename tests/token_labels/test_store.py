...
def test_the_fingerprint_covers_the_whole_matching_path() -> None:
    ...
    assert set(token_labels.labelling_rules()) == {
        ...
        "surface_forms.length_band_ratios",
        "surface_forms.word_spans",
        "token_labels.ANCHOR_COLUMNS",
        "token_labels.BACTERIA_PREFIX",
        ...
        "token_labels._DESIGNATION",
        "token_labels._DESIGNATION_CONNECTORS",
        "token_labels._DOTTED_CONNECTORS",
        ...
        "token_labels._mention_coverage",
        "token_labels._mention_type",
        "token_labels._overlapping_tokens",
        "token_labels._propagated_designations",
        "token_labels._unclaimed_accessions",
        "token_labels._whitespace_gap",
