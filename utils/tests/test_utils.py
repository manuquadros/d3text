...
def test_merge_does_not_duplicate() -> None:
    og = [
        ...
        Token(
            string="of", offset=(3434, 3436), prediction="O", gold_label=None
        ),
        Token(
            string="the", offset=(3437, 3440), prediction="O", gold_label=None
        ),
        Token(
            string="cholesterol",
            offset=(3441, 3452),
        ...
        Token(
            string="em", offset=(3453, 3455), prediction="O", gold_label=None
        ),
        Token(
            string="##uIs", offset=(3455, 3458), prediction="O", gold_label=None
        ),
        Token(
            string="##ification",
            offset=(3458, 3467),
        ...
        Token(
            string="COX", offset=(3496, 3499), prediction="O", gold_label=None
        ),
