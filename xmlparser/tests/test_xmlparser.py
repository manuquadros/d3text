...
from xmlparser import (Element, chars, copy_curies, curies, fromstring,
                       merge_children, promote_spans, reinsert_tags,
                       remove_tags, tostring, transform_article)
...
def test_reinsert_tags_preserves_outer_div():
    ...
    goal = [
        '<div prefix="ncbitaxon: http://purl.obolibrary.org/obo/NCBITaxon_"><p>The <span resource="#T1" typeof="ncbitaxon:OOS">bacteria</span> were grown on the GYS medium in a 2-liter scale fermentor in batch mode operation under pH and temperature controlled conditions. Under this conditions the cell yield was doubled (9.5 mg/ml vs. 4.8 mg/ml dry cell weight) and the cultivation time was reduced to one third (60 vs. 180 hours) as compared with shaken flasks. These results are in good agreement with the literature [<xref ref-type="bibr" rid="B12">12</xref>]. We found that addition of 2 g/l cholesterol to the culture broth [<xref ref-type="bibr" rid="B12">12</xref>], prepared as an aqueous emulsion with the aid of Tween 80 at a weight ratio 2:1 results in a high yield of COX production [<xref ref-type="bibr" rid="B9">9</xref>], but the preparation procedure of that emulsion had a marked influence in the final enzyme yield, although not on the cell weight, as seen in Table <xref ref-type="table" rid="T1">1</xref>. The spray-dry method resulted advantageous because the cholesterol :Tween <span resource="#T2" typeof="ncbitaxon:Strain">80</span> emulsion formed readily and COX production increased in overall by three times with respect to the preparation of the cholesterol:Tween <span resource="#T3" typeof="ncbitaxon:Strain">80</span> mixture at the flame. Enzyme production improvement resulted larger as cell-linked (3.8-fold) than as extracellular (2.3-fold). This overall increase of COX production can be due to a better availability of cholesterol to the cell since particle size obtained by spray-dry is smaller.</p></div>',
        '<chunk-body><div prefix="ncbitaxon: http://purl.obolibrary.org/obo/NCBITaxon_"><p>Distribution of COX activity among detergent depleted and detergent rich phases after induction of phase separation of cell extracts done with the indicated concentration of Triton X-114. (a) Total activity; (b) Specific activity.As Triton X-114 concentration is increased, COX partitions towards the detergent rich phase, increasing its specific activity (Figures <xref ref-type="fig" rid="F2">2b</xref> and <xref ref-type="fig" rid="F3">3b</xref>) thus resulting in enzyme purification and also in enzyme concentration since the volume of the detergent-rich phase is much lower than the initial volume. The 1% concentration of detergent was an exception to this rule since COX partitioned toward the depleted phase under our working conditions. Partitioning of commercial COX in buffers containing 1% Triton X-114 occurred toward the rich phase and was very influenced by the buffer concentration [<xref ref-type="bibr" rid="B16">16</xref>The purification was made evident by running samples of COX from cells and culture broth in SDS-PAGE gels. Figure <xref ref-type="fig" rid="F4">4</xref> shows that in both cases the detergent-rich phase was enriched in some proteins, including COX, whereas the depleted phase showed other different protein bands.</p><fig position="float" id="F4">           <label>Figure 4</label>           <caption>             <p>SDS-PAGE of COX fractions using 3% Triton X-114 for extraction, purification and concentration, (a) Cell extracts: lane 1, Mw markers; lane 2, commercial COX; lane 3, total extracted proteins; lane 4, proteins in detergent depleted phase; lane 5, proteins in detergent rich phase, (b) Culture broth: lane 1, Mw markers; lane 2, commercial COX; lane 3, proteins in detergent rich phase; lane 4, total proteins in culture broth; lane 5, proteins in detergent depleted phase. Arrows indicated the COX band.</p>           </caption>           <graphic xlink:href="1472-6750-2-3-4"></graphic>         </fig><p>SDS-PAGE of COX fractions using 3% Triton X-114 for extraction, purification and concentration, (a) Cell extracts: lane 1, Mw markers; lane 2, commercial COX; lane 3, total extracted proteins; lane 4, proteins in detergent depleted phase; lane 5, proteins in detergent rich phase, (b) Culture broth: lane 1, Mw markers; lane 2, commercial COX; lane 3, proteins in detergent rich phase; lane 4, total proteins in culture broth; lane 5, proteins in detergent depleted phase. Arrows indicated the COX band.An exceptional result was obtained when performing COX purification from the culture broth supplemented with a 6% w/v Triton X-114. The total activity recovered after phase separationseparation was ca. 3.5-fold that measured in the broth before phase separation. This result suggests that soluble COX produced by the culture is not fully active and that it can be activated by a treatment with 6% Triton X-114 but not with 4% or less. Further increase of Triton X-114 concentration results in no improvement with respect to 6% (results not shown). This phenomenon was not observed with COX extracted from cells, therefore the enzyme most likely exists in a fully active form in </p></div></chunk-body>',
    ]
...
def test_transform_article():
    ...
    goal = """<chunk><div xmlns="https://jats.nlm.nih.gov/ns/archiving/1.3/" class="metadata"><p>Excerpt from:<strong><italic xmlns="https://dtd.nlm.nih.gov/ns/archiving/2.3/">Rhodococcus erythropolis</italic> ATCC 25544 as a suitable source of cholesterol oxidase: cell-linked and extracellular enzyme synthesis, purification and concentration</strong></p><p>Authors:<name xmlns="https://dtd.nlm.nih.gov/ns/archiving/2.3/"><surname>Sojo,</surname>Mar M            -</name><name xmlns="https://dtd.nlm.nih.gov/ns/archiving/2.3/"><surname>Bru,</surname>Roque R            -</name><name xmlns="https://dtd.nlm.nih.gov/ns/archiving/2.3/"><surname>García-Carmona,</surname>Francisco F</name></p><p>DOI: 10.1186/1472-6750-2-3</p></div><div xmlns="https://jats.nlm.nih.gov/ns/archiving/1.3/" class="chunk-body"><p xmlns="https://dtd.nlm.nih.gov/ns/archiving/2.3/">In a previous work [<xref ref-type="bibr" rid="B9">9</xref>] we described the cell-bound and extracellular cholesterol oxidase activities from<italic><span resource="#T1" typeof="ncbitaxon:Species">R. erythropolis</span></italic><span resource="#T2" typeof="ncbitaxon:Strain">ATCC 25544</span>, achieving in optimal conditions 55% cell-bound and 45% extracellular activity. Their enzymatic properties strongly supported the idea that the particulate and the extracellular cholesterol oxidases are two different forms of the same enzyme with an estimated molecular mass of 55 kDa. In this work we optimize the culture conditions in a 2-liter fermentor of this extracellular cholesterol oxidase producer strain and carry out the extraction, partial purification and concentration of both types of cholesterol oxidase by using Triton X-114 phase separation. The results obtained are very promising for the use of this strain and this technique in the industrial processing of<span resource="#T3" typeof="ncbitaxon:OOS">bacteria</span>to obtain cholesterol oxidase.</p></div></chunk>"""

    goal = tostring(
        fromstring(goal), method="c14n2", strip_text=True, pretty_print=True
    )
