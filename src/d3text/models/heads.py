"""The classification heads and the layers they are built from.

Leaf modules: they know their input width and their output width and nothing
else — no config, no dataset, no schema. `base.Model` and its subclasses wire
them up.
"""
